...
pub fn meanie_list(list: *zgame.Canvas.List, renderer: zgame.sdl.Renderer) !void {
    try list.append(try zgame.Canvas.loadPng(renderer, images.meanie00)); // 0
    try list.append(try zgame.Canvas.loadPng(renderer, images.meanie01)); // 1
    try list.append(try zgame.Canvas.loadPng(renderer, images.meanie02)); // 3
    try list.append(try zgame.Canvas.loadPng(renderer, images.meanie10)); // 4
    try list.append(try zgame.Canvas.loadPng(renderer, images.meanie11)); // 5
    try list.append(try zgame.Canvas.loadPng(renderer, images.meanie12)); // 6
    try list.append(try zgame.Canvas.loadPng(renderer, images.meanie20)); // 7
    try list.append(try zgame.Canvas.loadPng(renderer, images.meanie21)); // 8
    try list.append(try zgame.Canvas.loadPng(renderer, images.meanie22)); // 9
}
